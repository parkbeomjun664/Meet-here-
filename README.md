...
> 중간지점 탐색 알고리즘의 상세 설계·수식·한계는 **[docs/algorithm.md](docs/algorithm.md)** 에 정리했습니다.
...
- **도서 지역**: 여객선 항로를 제공하는 API가 없어 육상 교통 기준으로만 계산합니다. 대신 출발지가 섬(옹진군·울릉군·제주)이면 **결과가 부정확할 수 있다는 경고를 표시**합니다 → 공공데이터포털 여객선 운항정보 연동 검토
